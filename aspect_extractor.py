"""
This file is used to extract aspects from each sentance. 
This is incomplete due to time constraints and problem complexity.
"""
...
class AspectExtractor:
    def __init__(self):
        ...
        self.positive_words =  nltk.word_tokenize(postive_words_file)
        self.negative_words =  nltk.word_tokenize(negative_words_file)

    def GetSentanceAspects(self, sentance = "Not the best build quality in the world (actually fairly thin plastic) but for $5 what else can you ask for?"):
        ...
        return [root,pairs,sent_sentiment]

    def traverse(self, node, node_level):
            pair = []
